  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-primary/10">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-500">
        <div>
          ...
          <p className="max-w-[410px] mt-6">
            ...
            by thousands, we aim to make your shopping experience hassle-free
            and enjoyable simple and affordable
          </p>
        </div>
      ...
      <p className="py-4 text-center text-sm md:text-base">
        Copyright {new Date().getFullYear()} © Fareed-Aslam All Right Reserved.
      </p>
    </div>
  );
};
